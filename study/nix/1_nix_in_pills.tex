...
\section{nix repl}
\label{sec:orgbe94e55}
\subsection{nix-repl> 명령어}
\label{sec:orgb636d9f}
\begin{center}
\begin{tabular}{ll}
:help & 도움말\\
입력 중간에 TAB & 자동 완성\\
