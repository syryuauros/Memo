...
begin\{figure\}
    \centering
    \subfloat[label 1]\{\{\includegraphics[width=0.3\textwidth]{../../img/7/Input pattern.png} \}\}
    \subfloat[label 2]\{\{\includegraphics[width=0.3\textwidth]{../../img/7/Input pattern.png} \}\}
\end{figure}


\subsection*{Table}
\label{sec:orgf202093}
...
\section*{Section title}
\label{sec:orgb67a25b}

\subsection*{Mathematics in latex}
\label{sec:orgbe941d4}
