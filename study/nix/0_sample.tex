...
\begin{wrapfigure}{l}{0.3\textwidth}
    \centering
    \includegraphics[width=0.25\textwidth]{../../img/7/fixedpoint.png}
\end{wrapfigure}
\textcolor{red}{this is how to insert figures between paragraphs.} asdkfjl akjwe jk ajsk jflkjflkj i akkjdxf l
skdjflkj safij kasfl jlkjaij kljwekj jkzxnnlk; wmnzkjojsaijra . jsalkjfpjwet askljlks flk  a sdklj
asdlkfj jtqwijsf kj kjasj \textcolor{orange}{한글도 사용해보자!! 색까지 넣어서!!} \\
...
This flowchart in Fig. \ref{fig:flowchart} is modified from \href{https://texample.net/tikz/examples/simple-flow-chart/}{this latex code}.
