...
* basic actions
| file generation | $ cat > [file-name] [cotents] C-c |
|                 |                                   |
...
| esc                          | i             | v [[https://m.blog.naver.com/wonmylover/220747912629][map]]       | :                                                             | REFs |
|------------------------------+---------------+-------------+---------------------------------------------------------------+------|
...
*git token approve (authentication problem, substitutes old 'password' method)
https://amkorousagi-money.tistory.com/entry/Git-personal-access-token

* etc
***  Emacs browser (wowser)  [[https://www.youtube.com/watch?v=GtFz19gj-m4][link]]
