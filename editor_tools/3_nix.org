...
* trouble shoot
+ error: getting status of [file name], dired mode에서 파일명 옆에 '?'가 떠있다.  --- git이 untrack중인 파일이라서 생기는 문제, stage해주면 해결됨
...
* flake  [[https://yuanwang.ca/posts/getting-started-with-flakes.html][link]]
**  basic usage guide [[https://nixos.wiki/wiki/Flakes][link]]
| nix flake check                    | checks."<system>."<name>"         |
| nix build .#<name>                 | packages."<system>."<name>"       |
| nix build .#<name>                 | legacyPackages."<system>."<name>" |
| nix run .#<name>                   | apps."<system>."<name>"           |
| nixos-rebuild --flake .#<hostname> | nixosConfigurations."<hostname>"  |
| nix develop .#<name>               | devShells."<system>."<name>"      |
| nix flake init -t <flake>#<name>   | templatess."<name>"               |
|                                    | overlays."<name>"                 |
|                                    | nixosModules."<name>"             |
|                                    |                                   |
**  useful and used many times
