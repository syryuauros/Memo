...
****  Manuals
 ...
 + [[https://github.com/NixOS/nixpkgs/tree/master/nixos][Nixos commands (pkgs, pkgs.lib, builtins): nix repl -> :l <nixpkgs>  or  /nix/store/currentNixOS/nixos/lib/ -> rg search]]
