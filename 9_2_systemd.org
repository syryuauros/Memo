...
* practice
| * systemd create unitfile & service  |                                     | [[https://www.diskinternals.com/linux-reader/systemd-startup-script/][link]] |
| * emacs as daemon(background server) | $ sudo emacs --daemon=foo           | [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Emacs-Server.html][link]] |
