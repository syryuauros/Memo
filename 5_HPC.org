...
$ nix build .#pixiecore .#wakeonlan .#syslinux .#mtools .#cpio

$ wget http://tinycorelinux.net/6.x/x86_64/release/distribution_files/{vmlinuz64,modules64.gz,corepure64.gz,rootfs64.gz}
$ sudo ./result-3/bin/pixiecore boot vmlinuz64 corepure64.gz rootfs64.gz modules64.gz --dhcp-no-bind -d -p80
$ ./result-2/bin/wakeonlan -p 8 54:05:DB:DC:4C:9D
